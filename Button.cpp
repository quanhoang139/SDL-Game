...
void Button::loadButton(SDL_Renderer* renderer, const int width, const int height, const int scrPosX, const int scrPosY, const std::string fiImgPath, std::string seImgPath) {
    this->width = width;
    this->height = height;
